...
public class CodeCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "CHAR", "INSERT", "CODE", "WHILE", "RES", "COMA", "APARENTESIS", 
			"CPARENTESIS", "ALLAVE", "CLLAVE", "EQUALS", "MUL", "DIV", "ADD", "SUB", 
			"PRINT", "IF", "ELSE", "COND_MAT", "COND_LOG", "STRING", "INT", "ID", 
			"FLOAT", "SEMI", "WS", "LINE_COMMENT", "BLOCK_COMMENT"
		};
	}
