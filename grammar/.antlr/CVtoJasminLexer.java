...
public class CVtoJasminLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "INSERT", "CODE", "MOD", "COMA", "NEGAN", 
	...
	public CVtoJasminLexer(CharStream input) {
		super(input);
